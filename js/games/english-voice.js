...
const EnglishVoiceGame = {
    ...
    words: {
        easy: [
            ...
            { image: '🐄', word: 'Cow', hebrew: 'פרה' },
            { image: '🐖', word: 'Pig', hebrew: 'חזיר' },
            { image: '🐓', word: 'Chicken', hebrew: 'תרנגול' },
            { image: '🐛', word: 'Bug', hebrew: 'חרק' },
            { image: '🐭', word: 'Mouse', hebrew: 'עכבר' },
            { image: '🐰', word: 'Rabbit', hebrew: 'ארנב' },
            // Food & Drink
            ...
            { image: '🍚', word: 'Rice', hebrew: 'אורז' },
            { image: '🧂', word: 'Salt', hebrew: 'מלח' },
            { image: '🍬', word: 'Candy', hebrew: 'סוכריה' },
            { image: '🍩', word: 'Donut', hebrew: 'סופגנייה' },
            { image: '🎂', word: 'Cake', hebrew: 'עוגה' },
            { image: '🍪', word: 'Cookie', hebrew: 'עוגייה' },
            // Nature
            ...
            { image: '☁️', word: 'Cloud', hebrew: 'ענן' },
            { image: '🪨', word: 'Rock', hebrew: 'סלע' },
            // Body
            { image: '👀', word: 'Eye', hebrew: 'עין' },
            { image: '✋', word: 'Hand', hebrew: 'יד' },
            { image: '🦶', word: 'Foot', hebrew: 'רגל' },
            { image: '👃', word: 'Nose', hebrew: 'אף' },
            { image: '👄', word: 'Mouth', hebrew: 'פה' },
            { image: '👂', word: 'Ear', hebrew: 'אוזן' },
            { image: '👶', word: 'Baby', hebrew: 'תינוק' },
            { image: '👦', word: 'Boy', hebrew: 'ילד' },
            { image: '👧', word: 'Girl', hebrew: 'ילדה' },
            // Home & Objects
            ...
            { image: '🛏️', word: 'Bed', hebrew: 'מיטה' },
            { image: '🪟', word: 'Window', hebrew: 'חלון' },
            { image: '🖊️', word: 'Pen', hebrew: 'עט' },
            { image: '📱', word: 'Phone', hebrew: 'טלפון' },
            { image: '💡', word: 'Light', hebrew: 'אור' },
            { image: '🧹', word: 'Broom', hebrew: 'מטאטא' },
            // Concepts
            { image: '❤️', word: 'Heart', hebrew: 'לב' },
            { image: '🎵', word: 'Music', hebrew: 'מוזיקה' },
            { image: '⏰', word: 'Clock', hebrew: 'שעון' },
            { image: '🔔', word: 'Bell', hebrew: 'פעמון' },
            { image: '🎨', word: 'Paint', hebrew: 'צבע' },
            { image: '🏃', word: 'Run', hebrew: 'ריצה' },
            { image: '😊', word: 'Happy', hebrew: 'שמח' },
            { image: '😢', word: 'Sad', hebrew: 'עצוב' },
            { image: '🔴', word: 'Red', hebrew: 'אדום' },
            { image: '🔵', word: 'Blue', hebrew: 'כחול' },
        ],
        medium: [
            // Animals
            ...
            { image: '🐬', word: 'Dolphin', hebrew: 'דולפין' },
            { image: '🐿️', word: 'Squirrel', hebrew: 'סנאי' },
            { image: '🦆', word: 'Duck', hebrew: 'ברווז' },
            { image: '🐍', word: 'Snake', hebrew: 'נחש' },
            { image: '🐠', word: 'Goldfish', hebrew: 'דג זהב' },
            { image: '🦐', word: 'Shrimp', hebrew: 'שרימפס' },
            // Food
            ...
            { image: '🍋', word: 'Lemon', hebrew: 'לימון' },
            { image: '🍉', word: 'Watermelon', hebrew: 'אבטיח' },
            { image: '🥒', word: 'Cucumber', hebrew: 'מלפפון' },
            { image: '🧅', word: 'Onion', hebrew: 'בצל' },
            { image: '🥔', word: 'Potato', hebrew: 'תפוח אדמה' },
            { image: '🍰', word: 'Pie', hebrew: 'פאי' },
            { image: '🥗', word: 'Salad', hebrew: 'סלט' },
            { image: '🍦', word: 'Ice cream', hebrew: 'גלידה' },
            // Nature
            ...
            { image: '🌪️', word: 'Tornado', hebrew: 'טורנדו' },
            { image: '🌴', word: 'Palm tree', hebrew: 'דקל' },
            { image: '🍂', word: 'Leaf', hebrew: 'עלה' },
            { image: '🌾', word: 'Wheat', hebrew: 'חיטה' },
            // Objects & Transport
            ...
            { image: '🚲', word: 'Bicycle', hebrew: 'אופניים' },
            { image: '🚂', word: 'Train', hebrew: 'רכבת' },
            { image: '🚢', word: 'Ship', hebrew: 'ספינה' },
            { image: '🎩', word: 'Hat', hebrew: 'כובע' },
            { image: '👓', word: 'Glasses', hebrew: 'משקפיים' },
            { image: '🧤', word: 'Gloves', hebrew: 'כפפות' },
            { image: '👗', word: 'Dress', hebrew: 'שמלה' },
            { image: '👟', word: 'Shoe', hebrew: 'נעל' },
            { image: '🧦', word: 'Socks', hebrew: 'גרביים' },
            { image: '☂️', word: 'Umbrella', hebrew: 'מטריה' },
            { image: '🪞', word: 'Mirror', hebrew: 'מראה' },
            { image: '🕯️', word: 'Candle', hebrew: 'נר' },
            { image: '✉️', word: 'Letter', hebrew: 'מכתב' },
        ],
        hard: [
            // Animals
            ...
            { image: '🐆', word: 'Leopard', hebrew: 'נמר' },
            { image: '🦇', word: 'Bat', hebrew: 'עטלף' },
            { image: '🐪', word: 'Camel', hebrew: 'גמל' },
            { image: '🦃', word: 'Turkey', hebrew: 'תרנגול הודו' },
            { image: '🐌', word: 'Snail', hebrew: 'חילזון' },
            { image: '🦟', word: 'Mosquito', hebrew: 'יתוש' },
            { image: '🦞', word: 'Lobster', hebrew: 'לובסטר' },
            // Places & Nature
            ...
            { image: '🏜️', word: 'Desert', hebrew: 'מדבר' },
            { image: '🏝️', word: 'Island', hebrew: 'אי' },
            { image: '🌊', word: 'Ocean', hebrew: 'אוקיינוס' },
            { image: '🗻', word: 'Summit', hebrew: 'פסגה' },
            { image: '🏕️', word: 'Camping', hebrew: 'קמפינג' },
            // Objects & Science
            ...
            { image: '🔮', word: 'Crystal', hebrew: 'קריסטל' },
            { image: '⚖️', word: 'Scale', hebrew: 'מאזניים' },
            { image: '🧪', word: 'Potion', hebrew: 'שיקוי' },
            { image: '🗡️', word: 'Sword', hebrew: 'חרב' },
            { image: '🛡️', word: 'Shield', hebrew: 'מגן' },
            // Professions & Actions
            { image: '👨‍⚕️', word: 'Doctor', hebrew: 'רופא' },
            { image: '👨‍🍳', word: 'Chef', hebrew: 'שף' },
            { image: '👮', word: 'Police', hebrew: 'שוטר' },
            { image: '👨‍🚒', word: 'Firefighter', hebrew: 'כבאי' },
            { image: '👨‍🏫', word: 'Teacher', hebrew: 'מורה' },
            { image: '👨‍🌾', word: 'Farmer', hebrew: 'חקלאי' },
            { image: '🧑‍🎨', word: 'Artist', hebrew: 'אמן' },
            { image: '👨‍✈️', word: 'Pilot', hebrew: 'טייס' },
            { image: '🏊', word: 'Swimming', hebrew: 'שחייה' },
            { image: '⛷️', word: 'Skiing', hebrew: 'סקי' },
            { image: '🎾', word: 'Tennis', hebrew: 'טניס' },
            { image: '⚽', word: 'Soccer', hebrew: 'כדורגל' },
            { image: '🏀', word: 'Basketball', hebrew: 'כדורסל' },
        ],
        expert: [
            // Exotic Animals
            ...
            { image: '🦏', word: 'Rhinoceros', hebrew: 'קרנף' },
            { image: '🦙', word: 'Llama', hebrew: 'לאמה' },
            { image: '🦨', word: 'Skunk', hebrew: 'בואש' },
            { image: '🦘', word: 'Kangaroo', hebrew: 'קנגורו' },
            { image: '🐃', word: 'Buffalo', hebrew: 'תאו' },
            { image: '🦬', word: 'Bison', hebrew: 'ביזון' },
            // Nature & Plants
            { image: '🪸', word: 'Coral', hebrew: 'אלמוג' },
            { image: '🪻', word: 'Lavender', hebrew: 'לבנדר' },
            { image: '🪹', word: 'Nest', hebrew: 'קן' },
            { image: '🍁', word: 'Maple', hebrew: 'מייפל' },
            { image: '🌺', word: 'Hibiscus', hebrew: 'היביסקוס' },
            { image: '🪷', word: 'Lotus', hebrew: 'לוטוס' },
            { image: '🎋', word: 'Bamboo', hebrew: 'במבוק' },
            { image: '🌿', word: 'Herb', hebrew: 'עשב' },
            // Structures & Objects
            ...
            { image: '🏗️', word: 'Crane', hebrew: 'מנוף' },
            { image: '🎠', word: 'Carousel', hebrew: 'קרוסלה' },
            { image: '⛲', word: 'Fountain', hebrew: 'מזרקה' },
            { image: '🗼', word: 'Tower', hebrew: 'מגדל' },
            { image: '🎡', word: 'Ferris wheel', hebrew: 'גלגל ענק' },
            // Abstract & Advanced
            { image: '🧬', word: 'DNA', hebrew: 'דנ"א' },
            { image: '⚛️', word: 'Atom', hebrew: 'אטום' },
            { image: '🔋', word: 'Battery', hebrew: 'סוללה' },
            { image: '📡', word: 'Satellite', hebrew: 'לוויין' },
            { image: '🧯', word: 'Extinguisher', hebrew: 'מטף' },
            { image: '🫖', word: 'Teapot', hebrew: 'קומקום' },
            { image: '🪤', word: 'Trap', hebrew: 'מלכודת' },
            { image: '🧿', word: 'Amulet', hebrew: 'קמע' },
            { image: '🪬', word: 'Hamsa', hebrew: 'חמסה' },
            { image: '🎗️', word: 'Ribbon', hebrew: 'סרט' },
        ]
    },
